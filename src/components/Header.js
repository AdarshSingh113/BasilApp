...
const Header = ({ ordersName, Allorders }) => {
  return (
    <div className="bg-white w-[1328px] mt-0.5 h-[85px] ml-[16px] flex items-center shadow-lg rounded-lg">
      ...
      <div className="flex items-center w-[227px] h-[38px]  ml-[669px] mr-[32px]">
        <div className="relative">
          ...
          <img
            src={Search_LOGO}
            className="absolute left-2 top-1/2 transform -translate-y-1/2 h-[16px] w-[16px]"
            alt="Search"
          />
        </div>
        <img
          src={Bell_LOGO}
          alt="Bell Logo"
          className="h-[18px] w-[16px] ml-[32px]"
        />
        <img
          src={Profile_LOGO}
          alt="Profile Logo"
          className="h-[36px] w-[36px] ml-[32px]"
        />
      </div>
    </div>
  );
